$(document).ready(function () {
    $.getJSON("facature.json", function (data) {
        ...
        let vacancyHead = data[2].sectionContent[2].sectionContent[0].objectValue
        let firstP = data[2].sectionContent[2].sectionContent[1].objectValue[0].objectValue
        let secondP = data[2].sectionContent[2].sectionContent[1].objectValue[1].objectValue
