$(document).ready(function () {
    $.getJSON("facature.json", function (data) {
        ...
        let paragraph = data[2].sectionContent[6].sectionContent[1].objectValue[0].objectValue
        let circle = data[2].sectionContent[6].sectionContent[1].objectValue[1].objectValue
