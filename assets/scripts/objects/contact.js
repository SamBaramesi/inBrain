$(document).ready(function () {
    $.getJSON("facature.json", function (data) {
        ...
        let title = data[2].sectionContent[1].sectionContent[0].objectValue;
        let contactName = data[2].sectionContent[1].sectionContent[1].objectValue[0].contactName;
        let contactTitle = data[2].sectionContent[1].sectionContent[1].objectValue[0].contactTitle;
        let contactEmail = data[2].sectionContent[1].sectionContent[1].objectValue[0].contactEmail;
