...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $_SESSION['vacature_id'] = $vacature_id;
    ...
    $stmt = $pdo->prepare("INSERT INTO workwithusicons (`vacature_id`,`icon_name`,`icon_text`,`icon_text`) SELECT $vacature_id,`icon_name`,`icon_text`,`icon_text` FROM workwithusicons WHERE id = id");
    $stmt->execute();
